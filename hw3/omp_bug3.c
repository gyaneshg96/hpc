...
// The barrier was present in both the sections. This will create a deadlock as both threads will be waiting 
// for each other to finish and will be stuck forever. Instead we can remove that and if we want them to wait
// we can remove the nowait
